	...
	<div class='col-sm-12'>
		...
		?>
			<div class="form-group">
				<select class="form-control" name="sel_city_id">
					<option value="-1"><?php echo $this->lang->line('select_city_message')?></option>
					<?php
						foreach($this->city->get_all()->result() as $city) {
							echo "<option value='" . $city->id . "'";
							if ($sel_city_id == $city->id) echo " selected ";
			...
			<div class="form-group">
				<input type="text" name="keyword" class="form-control" placeholder="Search" value="<?php echo $keyword;?>">
			</div>

			<button type="submit" class="btn btn-primary"><?php echo $this->lang->line('search_button')?></button>
			<a href='<?php echo site_url('items/search');?>' class="btn btn-default"><?php echo $this->lang->line('reset_button')?></a>
		</form>
	</div>
</div>
	      ...
	      <div class="top-border">
	        ...
	        <div class="col-md-8 ibox-content profile-content">
	          ...
	          <div class="row m-t-lg">
	            ...
	            <div class="col-md-4">
	              <span class="bar">5,3,9,6,5,9,7,3,5,2</span>
	              <p><?php echo $this->inquiry->count_all($sel_city_id, $item->id) ?> Inquiry</p>
	            </div>
	          </div>
	        </div>
	        <div class="cls"></div>
